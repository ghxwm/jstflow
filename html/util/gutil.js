...
(function() { //init alias for global object
	var SPECIAL_PROP_OBJ_ALIAS = "taint_*alias*";//对象的名字.用于别名
	document[SPECIAL_PROP_OBJ_ALIAS]='document';
	window[SPECIAL_PROP_OBJ_ALIAS]='window';
	location[SPECIAL_PROP_OBJ_ALIAS]='location';
	history[SPECIAL_PROP_OBJ_ALIAS]='history';
})();
